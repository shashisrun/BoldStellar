...
class BLOG extends Component{	
    ...
    async CreateBLOG(event) {
        ...
        const response = await ApiRepository.CreateBLOG(postData);
        if(response){
    ...
    async UpdateBLOG(event) {
        ...
        var id = state.id
        const postData = { title:  state.title, url:    state.url, parent: state.parent, status: state.status, sortby: state.sortby }
        const response = await ApiRepository.UpdateBLOG(id, postData);
        if(response){
    ...
    async DistroyBLOG(event) {
        event.preventDefault();
        var id = ([event.target.name] == "delete-single")? this.state.distroy.id : ''
        const response = await ApiRepository.DistroyBLOG(id);
        if(response){
            console.log(JSON.stringify(response))
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                id	meta_title	meta_description	meta_image	meta_keyword	status	title	content	slug	authored_by	authored_on	created_at	updated_at

                                    <div className="form-group row">
                                        <label htmlFor="title" className="col-md-4 col-form-label text-md-right">Meta Title</label>
                            ...
                            <div className="card-body">
                            <form onSubmit={event => this.UpdateBLOG(event)}>
                            ...
                            <div className="card-body">
                                <form name="delete-single" onSubmit={event => this.DistroyBLOG(event)}>
                                    <div className="form-group row">
                                        <label htmlFor="id" className="col-md-4 col-form-label text-md-right">ID</label>
                                ...
                                <form name="delete-all" onSubmit={event => this.DistroyBLOG(event)}>
                                    <div className="form-group row mb-0">
                                        <div className="col-md-8 offset-md-4">
                            ...
                            <div className="card-body">
                                ...
                                <form name="fetch-single" onSubmit={event => this.GetBLOG(event)}>
                                    <div className="form-group row">
                                        <label htmlFor="id" className="col-md-4 col-form-label text-md-right">ID</label>
                                ...
                                <form name="fetch-all" onSubmit={event => this.GetBLOG(event)}>
                                    <div className="form-group row mb-0">
                                        <div className="col-md-8 offset-md-4">
